...
* エンティティ属性を渡す別の方法として、[!DNL Target] UIで製品カタログを更新して、[推奨事項](https://experienceleague.adobe.com/docs/target/using/recommendations/entities/feeds.html?lang=ja){target=_blank}を使用する方法があります。
