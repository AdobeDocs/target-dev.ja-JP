---
keywords: 実装，実装，実装，adobe launch, launch, race, redirect, experience platform launch, platform launch, tags, adobe platform, implement2
description: Targetの実装方法として推奨される [!DNL Adobe Experience Platform]を使用して、 [!DNL Adobe Target] at.js ライブラリを実装する方法について説明します。
