...
at.js バージョン 2.x （バージョン 2.10.0以前）の場合、*1st パーティ Cookieのみがサポートされます*。 at.js 1.*x*&#x200B;は、1st パーティ Cookieである「mbox」が`clientdomain.com`に保存され、`clientdomain`はドメインです。
