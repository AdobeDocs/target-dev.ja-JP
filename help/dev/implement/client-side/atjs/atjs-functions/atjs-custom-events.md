---
keywords: カスタムイベント、at.js、リクエスト失敗、リクエスト成功、コンテンツレンダリング失敗、コンテンツレンダリング成功、ライブラリ読み込み、リクエスト開始、コンテンツレンダリング開始、オファーなし、コンテンツレンダリングのリダイレクト、カスタムイベント 2
description: at [!DNL Adobe Target] js JavaScript ライブラリのカスタムイベントを使用すると、mbox のリクエストやオファーが失敗または成功した場合に通知されます。
