...
サイトの設定によって、どの Cookie を使用するかが決まります。ファーストパーティとサードパーティの Cookie を理解しようとする際に、[!DNL Target] がどのように機能するかを理解すると役に立ちます。 詳しくは [ [!DNL Adobe Target]  仕組み ](https://experienceleague.adobe.com/docs/target/using/introduction/how-target-works.html?lang=ja) を参照してください。
