...
詳しくは、*Edge Network Server API ドキュメント*&#x200B;の[Edge Server APIの概要](https://experienceleague.adobe.com/docs/experience-platform/edge-network-server-api/overview.html){target=_blank}を参照してください。
