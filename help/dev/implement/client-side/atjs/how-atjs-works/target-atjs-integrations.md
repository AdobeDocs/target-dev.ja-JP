...
description: '[!UICONTROL Analytics for Target] （A4T）、[!UICONTROL Experience Cloud ID Service]など、 [!DNL Adobe Target] at.jsでサポートされている（サポートされていない）統合を参照してください。'
