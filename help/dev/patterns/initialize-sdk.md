---
title: SDK の初期化
description: Adobe Experience Platform Web SDK の読み込みに必要なすべての手順が正しい順序で実行されていることを確認します。
feature: APIs/SDKs
level: Experienced
role: Developer
hide: true
...
![SDK ダイアグラムの初期化](/help/dev/patterns/assets/diagram-initiaze-sdk.png){width="600" zoomable="yes"}
...
![訪問者 API SDK の図を読み込み](/help/dev/patterns/assets/load-visitor-api-sdk.png){width="100" zoomable="yes"}
...
![顧客 ID を設定](/help/dev/patterns/assets/set-customer-id.png){width="100" zoomable="yes"}
...
![自動ページ読み込みリクエストの設定](/help/dev/patterns/assets/configure-automatic-page-request.png){width="100" zoomable="yes"}
...
![ちらつき処理図の設定](/help/dev/patterns/assets/flicker-handling.png){width="100" zoomable="yes"}
...
![データマッピング図](/help/dev/patterns/assets/data-mapping.png){width="100" zoomable="yes"}
...
![リモートデータマッピング図](/help/dev/patterns/assets/remote-data-mapping.png){width="100" zoomable="yes"}
...
![Adobe Target Web SDK の図を読み込む](/help/dev/patterns/assets/load-web-sdk.png){width="100" zoomable="yes"}
