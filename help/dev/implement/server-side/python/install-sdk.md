...
description: ' [!DNL Adobe Target] Python SDKのインストール方法について説明します。'
feature: APIs/SDKs
...
Python SDKは[pypi](https://pypi.org/project/target-python-sdk)によって配布されています。 開始するには、pip経由でインストールして依存関係として追加します。
