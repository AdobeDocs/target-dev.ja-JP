...
description: データと  [!DNL Adobe Target] エクスペリエンスのセキュリティを強化するためにアドビが使用する手順について説明します。
...
Adobe がデータと [!DNL Adobe Target] エクスペリエンスのセキュリティを強化するために導入している詳細なアプローチとセキュリティ対応について説明します。
