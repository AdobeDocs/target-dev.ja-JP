...
詳しくは、 `TargetRequestUtils.java`を参照してください。 [ユーティリティメソッド (Java)](https://experienceleague.adobe.com/docs/target-dev/developer/server-side/java/utility-methods.html){target=_blank}
