...
Models API を使用する場合、{Target Admin API[ を使用する場合と同様に、{0](https://developer.adobe.com/console/home)Adobe Developer Console[ を使用して認証を設定する必要があります。 ](../administer/admin-api/admin-api-overview-new.md)詳しくは、[ 認証の設定方法 ](../before-administer/configure-authentication.md) を参照してください。
