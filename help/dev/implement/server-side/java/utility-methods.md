---
title: ' [!DNL Adobe Target] Java SDKでのユーティリティメソッドの使用'
description: コントローラ間で再利用可能で、別のユーティリティクラスに移動できるヘルパーメソッドの使用方法を説明します。
feature: APIs/SDKs
...
これらのヘルパーメソッドはコントローラ間で再利用でき、別のユーティリティクラスに移動できます。
