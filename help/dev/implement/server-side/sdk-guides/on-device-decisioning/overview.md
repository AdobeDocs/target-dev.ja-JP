...
オンデバイス判定では、[ フォームベースの Experience Composer](https://experienceleague.adobe.com/docs/target/using/experiences/form-experience-composer.html) で作成された次のアクティビティタイプをサポートしています。
