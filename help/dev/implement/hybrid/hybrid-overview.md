---
keywords: ハイブリッドデプロイメント，ハイブリッド，サーバーサイド，サーバーサイド，サーバーサイド，クライアントサイド，クライアントサイド，ハイブリッド実装，ハイブリッドデプロイメント 0
description: クライアントサイドとサーバーサイドの実装を組み合わせた、パーソナライゼーションのための [!DNL Adobe Target]独自のハイブリッドデプロイメントモデルについて説明します。
